    ...
    function PointSymbol(symbolObj, opacity) {
        ...
        switch (_this2.symbolObj['type']) {
            case 'esriSMS':
                ...
                _this2.olStyle = new ol.style.Style({
            ...
            case 'esriPMS':
                _this2.olStyle = new ol.style.Style({
                    image: new ol.style.Icon({ src: 'data:image/png;base64,' + _this2.symbolObj['imageData'] })
                });
    ...
    function LineSymbol(symbolObj, opacity) {
        ...
        switch (_this3.symbolObj['type']) {
            case 'esriSLS':
                ...
                _this3.olStyle = new ol.style.Style({
    ...
    function PolygonSymbol(symbolObj, opacity) {
        ...
        switch (_this4.symbolObj['type']) {
            case 'esriSFS':
                ...
                _this4.olStyle = new ol.style.Style({
                    stroke: new ol.style.Stroke({
                        color: outerColor,
                        //lineDash: [4],
                        width: outlineWidth
